...
import com.example.project.databinding.RowPdfFavoriteBinding;
...
public class AdapterPdfFavorite extends RecyclerView.Adapter<AdapterPdfFavorite.HolderPdfFavorite>{
   ...
   /*private void loadBookDetails(ModelPdf model) {
        String bookId = model.getId();
        Log.d(TAG,"loadBookDetails: Book Details of ID: "+bookId);
    ...
    public int getItemCount() {
        return 0; //return list size || number of records
    }
