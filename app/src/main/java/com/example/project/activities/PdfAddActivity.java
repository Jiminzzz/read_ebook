...
import com.example.project.databinding.ActivityPdfAddBinding;
...
public class PdfAddActivity extends AppCompatActivity {
    ...
    private void validateData() {
        ...
        title = binding.titleTil.getText().toString().trim();
    ...
    private void uploadPdfInfoToDb(String uploadPdfUrl, long timestamp) {
        ...
        progressDialog.setMessage("Uploading pgf info...");
    ...
    private void categoryPickDialog() {
        Log.d(TAG,"categoryPickDialog:s showing category pick dialog");
